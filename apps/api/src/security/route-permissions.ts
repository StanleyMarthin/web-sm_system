...
function getRoutePermissions(): readonly RoutePermission[] {
  ...
  { method: "PUT", path: "/api/wo/*", permission: permissionCodes.woCreate },
  { method: "POST", path: "/api/pr", permission: permissionCodes.prCreate },
  { method: "PUT", path: "/api/pr/*", permission: permissionCodes.prCreate },
  ...
  { method: "PUT", path: "/api/vendor/*", permission: permissionCodes.vendorCreate },
