...
import {
  ...
  handleUnitCatalogPanelAliasRoute,
  handleUnitCatalogPanelItemsAliasRoute,
  handleUnitCatalogPanelItemsBatchRoute,
  handleUnitCatalogPanelJobdescsRoute,
  handleUnitCatalogPanelImageUploadRoute,
  handleUnitCatalogPanelMediaAliasRoute,
  handleUnitCatalogPanelWorkspaceRoute,
  handleUnitCatalogPanelRoute,
  handleUnitCatalogPromoteRoute,
  handleUnitCatalogRoute,
  handleUnitCatalogSearchRoute,
...
export function createApiFetchHandler(dependencies: AppDependencies = {}) {
  ...
  const routes: AppRoute[] = [
    ...
    { method: "POST", pattern: /^\/api\/units\/([^/]+)\/catalog\/panel-images\/upload$/, handler: (request, match) => handleUnitCatalogPanelImageUploadRoute(request, match![1], getAuthService()) },
    ...
    { method: "GET", pattern: /^\/api\/units\/([^/]+)\/catalog\/panels\/(\d+)$/, handler: (request, match) => handleUnitCatalogPanelWorkspaceRoute(request, match![1], Number.parseInt(match![2], 10), getAuthService(), getUnitCatalogService()) },
    { method: "PUT", pattern: /^\/api\/units\/([^/]+)\/catalog\/panels\/(\d+)\/items\/batch$/, handler: (request, match) => handleUnitCatalogPanelItemsBatchRoute(request, match![1], Number.parseInt(match![2], 10), getAuthService(), getUnitCatalogService()) },
