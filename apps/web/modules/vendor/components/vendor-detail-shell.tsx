        ...
        <div className="mt-5 grid gap-4 xl:grid-cols-[minmax(0,0.8fr)_minmax(0,1fr)_minmax(0,0.9fr)]">
          <div className="rounded-3xl border border-white/[0.06] bg-white/[0.025] p-4">
            ...
            <textarea
              ...
              className="mt-3 min-h-28 w-full rounded-3xl border border-white/[0.06] bg-white/[0.03] px-4 py-3 text-sm text-white outline-none placeholder:text-white/15 focus:border-amber-500/30"
            />
          </div>
