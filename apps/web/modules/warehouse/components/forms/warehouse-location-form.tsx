    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="grid gap-4 md:grid-cols-2">
        <label className="grid gap-2 text-sm text-white/75">
          ...
          {errors.locationType && <span className="text-xs text-red-400">{errors.locationType.message}</span>}
        </label>
        ...
        <label className="flex h-9 items-center gap-2 self-end rounded-lg border border-white/[0.08] bg-white/[0.03] px-3 text-sm text-white/75">
