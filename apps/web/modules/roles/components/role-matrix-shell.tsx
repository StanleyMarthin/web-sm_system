...
function ScopeDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 px-4 py-6 backdrop-blur-sm">
      <div className="mx-auto flex h-full max-w-4xl flex-col border border-white/10 bg-[#0a0a0c]">
        <div className="flex items-start justify-between gap-4 border-b border-white/5 px-6 py-4">
          <div>
            ...
            <h3 className="text-[13px] font-mono text-white mt-0.5">
          ...
          <button
            type="button"
            onClick={onClose}
            className="border border-white/10 p-1.5 text-white/40 hover:text-white transition-colors"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="grid min-h-0 flex-1 gap-6 overflow-hidden px-6 py-5 lg:grid-cols-[380px_minmax(0,1fr)]">
          <div className="border border-white/5 bg-[#111114] p-4">
            <p className="text-[10px] font-mono uppercase tracking-[0.12em] text-white/30">
              Pilih model akses
            </p>
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <p className="text-[11px] font-mono text-white">{option.label}</p>
                      {selected ? (
          ...
          <div className="flex min-h-0 flex-col border border-white/5 bg-[#111114] p-4">
            ...
            {usesList ? (
              <>
                <div className="mt-5 grid gap-3 lg:grid-cols-[minmax(0,1fr)_240px_auto]">
                  <label className="space-y-1">
                    ...
                    <input
                      ...
                      className="h-8 w-full border border-white/10 bg-[#0a0a0c] px-2 text-[11px] font-mono text-white outline-none focus:border-amber-500/40"
                    />
                  </label>
                ...
                <div className="mt-4 min-h-0 flex-1 overflow-hidden border border-white/5">
                  <div className="grid grid-cols-[48px_minmax(0,1fr)] border-b border-white/5 px-3 py-1.5 text-[10px] font-mono uppercase tracking-[0.12em] text-white/25">
                    <span>No</span>
                    <span>{isDivision ? "Divisi" : "Unit"}</span>
                  </div>
                  <div className="max-h-[340px] overflow-y-auto">
                    {selectedIds.length === 0 ? (
                      <div className="px-3 py-6 text-[11px] font-mono text-white/25">
              ...
              <div className="mt-4 border border-white/5 px-3 py-4 text-[11px] font-mono text-white/30">
        ...
        <div className="flex items-center justify-end gap-3 border-t border-white/5 px-6 py-3">
          <button
            type="button"
            onClick={onClose}
...
export function RoleMatrixShell({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="border border-white/5 bg-[#111114] p-4">
        <div className="flex flex-col gap-3 border-b border-white/5 pb-3 xl:flex-row xl:items-center xl:justify-between">
          <div>
            ...
            <h2 className="text-[13px] font-mono text-white/80 mt-0.5">
          ...
          <button
            ...
            className="flex items-center gap-1.5 border border-white/10 bg-[#0a0a0c] px-3 py-1.5 text-[10px] font-mono uppercase tracking-[0.12em] text-white/50 hover:text-white hover:border-white/30 transition-colors"
          >
        ...
        <div className="mt-4 grid gap-4 xl:grid-cols-[minmax(0,390px)_minmax(0,1fr)]">
            ...
            <label className="space-y-1">
              ...
              <div className="flex items-center gap-2 border-b border-white/10 px-2">
                ...
                <input
                  ...
                  className="h-8 w-full bg-transparent text-[11px] font-mono text-white outline-none placeholder:text-white/20"
                />
              </div>
            </label>

            {showSearchResults ? (
              <div className="border border-white/5 bg-[#0a0a0c]">
                <div className="max-h-[260px] overflow-y-auto">
                  {filteredRoles.length === 0 ? (
                    <div className="px-3 py-3 text-[10px] font-mono text-white/25">
                    ...
                    filteredRoles.map((role) => {
                      ...
                      return (
                        <button
                          ...
                          className={[
                            "w-full border-b border-white/5 px-3 py-2 text-left transition-colors",
                            selected
                        ...
                        >
                          <div className="flex items-start justify-between gap-3">
                            <div>
                              <p className="text-[11px] font-mono text-white">{role.roleName}</p>
                              <p className="text-[10px] text-white/30 mt-0.5">
                                {role.description ?? "Belum ada catatan role."}
                              </p>
                            </div>
                            <span className="font-mono text-[10px] text-white/30 border border-white/10 px-1.5 py-0.5 shrink-0">
          ...
          <div className="border border-white/5 bg-[#0a0a0c] p-4">
            <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="grid gap-2 sm:grid-cols-3 lg:min-w-[420px]">
                <div className="border border-white/5 bg-[#111114] px-3 py-2">
                  <p className="text-[10px] font-mono uppercase tracking-[0.12em] text-white/30">
                    Level
                  </p>
                  <p className="text-[12px] font-mono text-white mt-0.5">{form.roleLevel || "-"}</p>
                </div>
                <div className="border border-white/5 bg-[#111114] px-3 py-2">
                  <p className="text-[10px] font-mono uppercase tracking-[0.12em] text-white/30">
                    Approval
                  </p>
                  <p className="text-[12px] font-mono text-white mt-0.5">{form.approvalRank || "-"}</p>
                </div>
                <div className="border border-white/5 bg-[#111114] px-3 py-2">
                  <p className="text-[10px] font-mono uppercase tracking-[0.12em] text-white/30">
                    Runtime Scope
                  </p>
                  <p className="text-[12px] font-mono text-white mt-0.5">{humanizeDerivedScope(derivedScopeBasis)}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="border border-white/5 bg-[#111114] p-4">
        <div className="flex flex-col gap-3 border-b border-white/5 pb-3 lg:flex-row lg:items-start lg:justify-between">
          <div>
            <p className="text-[10px] font-mono uppercase tracking-[0.12em] text-white/30">
              Pengaturan Role
            </p>
            <h1 className="text-[13px] font-mono text-white mt-0.5">
          ...
          <div className="flex flex-wrap items-center gap-2">
            {editorMode === "edit" ? (
              <button
                ...
                className="flex items-center gap-1.5 border border-white/10 px-3 py-1.5 text-[10px] font-mono uppercase tracking-[0.12em] text-white/50 hover:text-white transition-colors"
              >
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <label className="space-y-1">
            ...
            <input
              ...
              className="h-8 w-full border border-white/10 bg-[#0a0a0c] px-2 text-[11px] font-mono text-white outline-none focus:border-amber-500/40 disabled:cursor-not-allowed disabled:opacity-70"
            />
          </label>
          ...
          <div className="md:col-span-2 border border-white/5 bg-[#0a0a0c] p-4">
            <div className="flex items-start justify-between gap-4">
              <p className="text-[10px] font-mono uppercase tracking-[0.12em] text-white/30">
                Lane Approval &amp; Tingkatan
              </p>
              <div className="border border-white/5 bg-[#111114] px-3 py-2 text-right shrink-0">
                <p className="text-[10px] font-mono uppercase tracking-[0.12em] text-white/30">Nilai aktif</p>
                <p className="text-[12px] font-mono text-white mt-0.5">
            ...
            <div className="mt-4 grid gap-2 xl:grid-cols-3">
              {approvalChoices.map((blueprint) => {
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      <p className="text-[11px] font-mono text-white">{blueprint.label}</p>
                      {selected ? (
                        <ShieldCheck className="mt-0.5 h-3.5 w-3.5 text-amber-400 shrink-0" />
                      ) : null}
                    </div>
                    <div className="mt-2 flex flex-wrap gap-2 text-[10px] font-mono uppercase tracking-[0.12em] text-white/30">
          ...
          <div className="md:col-span-2 border border-white/5 bg-[#0a0a0c] p-4">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="border border-white/5 bg-[#111114] px-3 py-1.5 text-[11px] font-mono text-white/50 shrink-0">
            ...
            <div className="mt-4 grid gap-3 xl:grid-cols-2">
              <div className="border border-white/5 bg-[#111114] px-4 py-3">
                <div className="flex items-start justify-between gap-4">
                  <p className="text-[11px] font-mono text-white">Akses Divisi</p>
                  <button
                    type="button"
                    onClick={() => setScopeDialog("division")}
                    disabled={!canEditProfile || isReservedSuperAdmin}
                    className="border border-white/10 px-2 py-1 text-[10px] font-mono uppercase text-white/40 hover:text-white transition-colors disabled:opacity-40"
                  >
                    Atur
                  </button>
                </div>
                ...
                <div className="mt-3 flex flex-wrap gap-1.5">
                  <span className="border border-white/10 px-2 py-0.5 text-[10px] font-mono uppercase text-white/40">
                  ...
                  {divisionLabels.length > 4 ? (
                    <span className="border border-white/10 px-2 py-0.5 text-[10px] font-mono text-white/30">
              ...
              <div className="border border-white/5 bg-[#111114] px-4 py-3">
                <div className="flex items-start justify-between gap-4">
                  <p className="text-[11px] font-mono text-white">Akses Unit</p>
                  <button
                    type="button"
          ...
          <label className="space-y-1 md:col-span-2">
            ...
            <textarea
              ...
              disabled={!canEditProfile || isReservedSuperAdmin}
              rows={3}
              className="w-full border border-white/10 bg-[#0a0a0c] px-2 py-2 text-[11px] font-mono text-white outline-none focus:border-amber-500/40 disabled:cursor-not-allowed disabled:opacity-70"
              placeholder="Catatan teknis role..."
            />
          </label>

          <div className="grid gap-2 md:col-span-2 md:grid-cols-2">
            <label className="flex items-center gap-3 border border-white/5 bg-[#0a0a0c] px-4 py-2">
              <input
                type="checkbox"
              ...
              />
              <p className="text-[11px] font-mono text-white">Aktif di Web</p>
            </label>
            ...
            <label className="flex items-center gap-3 border border-white/5 bg-[#0a0a0c] px-4 py-2">
              <input
                ...
                className="h-4 w-4 rounded border-white/20 bg-transparent text-amber-500"
              />
              <p className="text-[11px] font-mono text-white">Aktif di Mobile</p>
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="border border-white/5 bg-[#111114] p-4">
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          ...
          <div className="border border-white/5 px-2 py-0.5 text-[10px] font-mono text-white/30">
        ...
        <div className="mt-4 flex justify-end">
          <div className="border border-white/5 bg-[#0a0a0c] px-3 py-2">
            <p className="text-[10px] font-mono uppercase tracking-[0.12em] text-white/30">Ringkasan lane</p>
        ...
        <input
          ...
          className="h-7 w-full border-b border-white/10 bg-transparent px-4 text-[11px] font-mono text-white/60 outline-none placeholder:text-white/20"
        />

        <div className="mt-0 border border-white/5 overflow-hidden">
          <div className="overflow-auto max-h-[480px]">
            <table className="min-w-full text-left">
              <thead className="sticky top-0 z-10 bg-[#0a0a0c] text-[11px] uppercase tracking-[0.12em] text-white/30 border-b border-white/10">
                <tr>
                ...
                {filteredPermissionGroups.length === 0 ? (
                  ...
                  filteredPermissionGroups.map((group) => (
                    <Fragment key={group.moduleName}>
                      <tr className="border-t border-white/5 bg-[#0a0a0c]">
                        <td colSpan={3} className="px-4 py-1.5">
                          <div className="flex items-center justify-between gap-3">
                            <span className="text-[10px] font-mono uppercase tracking-[0.12em] text-white/30">
                              {group.moduleName}
                            </span>
                            <span className="border border-white/10 px-1.5 py-0.5 text-[10px] font-mono text-white/30">
                              {group.items.length}
                            </span>
                          </div>
                        </td>
                      ...
                      {group.items.map((permission) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-4 py-1.5 text-[10px] text-white/30">
