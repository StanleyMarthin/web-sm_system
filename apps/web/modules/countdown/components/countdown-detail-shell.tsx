      ...
      <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <h1 className="mt-3 text-2xl font-light text-foreground">{countdown.unitName}</h1>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full border border-success/30 bg-success/10 px-4 py-2 text-sm text-success hover:bg-success/20"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full border border-info/30 bg-info/10 px-4 py-2 text-sm text-info hover:bg-info/20"
            >
            ...
            <Link
              href="/countdown"
              className="inline-flex items-center gap-2 rounded-full border border-white/[0.06] px-4 py-2 text-sm text-foreground/65 hover:text-foreground"
            >
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        <section className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-6">
          <div className="flex items-center gap-3">
            <Clock3 className="h-4 w-4 text-app-accent-ink" />
            <h2 className="text-sm uppercase tracking-[0.18em] text-foreground/45">
              Ringkasan
            </h2>
          </div>
        ...
        <section className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-6">
          <div className="flex items-center gap-3">
            <Layers3 className="h-4 w-4 text-app-accent-ink" />
            <h2 className="text-sm uppercase tracking-[0.18em] text-foreground/45">
              Cakupan
            </h2>
          </div>
      ...
      <section className="rounded-2xl border border-white/[0.06] bg-white/[0.03] p-6">
        ...
        <div className="mt-4 overflow-x-auto rounded-2xl border border-white/[0.06]">
          <table className="min-w-full border-separate border-spacing-0">
            <thead>
              <tr className="bg-black/30 text-left text-[11px] uppercase tracking-[0.16em] text-foreground/35">
            ...
            <tbody>
              {countdown.details.map((detail) => (
                <tr key={detail.detailId} className="border-t border-white/[0.06] text-sm text-foreground/70">
              ...
              {countdown.details.length === 0 ? (
                <tr>
                  <td className="px-4 py-4 text-sm text-foreground/45" colSpan={7}>
