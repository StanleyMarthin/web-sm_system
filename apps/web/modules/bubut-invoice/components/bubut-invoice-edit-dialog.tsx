    ...
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/70 p-4 pt-16 print:hidden">
      <div className="w-full max-w-4xl border border-white/10 bg-[#111114] text-white">
        ...
        <div className="flex items-center justify-between border-b border-white/5 px-4 py-3">
          <div>
            <p className="font-mono text-[12px] uppercase tracking-[0.1em] text-white">
        ...
        <div className="flex justify-end gap-2 border-t border-white/5 px-4 py-3">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-sm bg-amber-500 px-6 py-2.5 font-mono text-[11px] font-bold uppercase tracking-[0.1em] text-amber-950 transition-colors hover:bg-amber-400 disabled:opacity-50"
          >
